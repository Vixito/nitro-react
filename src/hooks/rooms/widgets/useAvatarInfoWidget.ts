...
const useAvatarInfoWidgetState = () =>
{
    ...
    useObjectSelectedEvent(event =>
    {
        ...
        {
            SendMessageComposer(new RoomUserClickFurniComposer(event.id));
        }
    });
